...
def read_prompt(function_name):
    ...
    try:
        ...
        return f"Prompt file not found for {function_name}"
...
async def answer_user(file_path:str, location:int, context: str, user_input: str):
    ...
    """
    prompt_template = read_prompt("answer_user")
...
async def research_topic(file_path: str,context: str, topic: str):
    ...
    prompt_template = read_prompt("research_topic")
    ...
    try:
        ...
        return 
@mcp.tool()
async def elaborate_question(subject: str, profile: str, context: str = ""):
    ...
    """
    # Read the prompt template
    prompt_template = read_prompt("elaborate_question")
